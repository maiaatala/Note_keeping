...
- [CPU turbo boost on and the overheating](#cpu-turbo-boost-on-and-the-overheating)
...
## CPU turbo boost on and the overheating

check cpu frequencies with `lscpu | grep MHz`
